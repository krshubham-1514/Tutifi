...
<body>
	...
	<form action="" method="post" id="form">
		...
		<li style="position:relative;"><input type="password" name="pass" placeholder=" Password" id="password1" required><ion-icon name="eye" id="password_show_1" onclick="show_hide_1()" style="position:absolute;top:50%;left:87%;cursor:pointer;"></ion-icon></li><br>
	   ...
	   <a href="user_account.php" style="background-color:#cc324b;padding:3%;border:0;border-radius:3px;color:white;text-decoration:none;">Create a account</a>
       </div>
	   <br>
	   <br>
	</form>
