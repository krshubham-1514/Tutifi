...
if(isset($_POST['submit']))
{
 ...
 {
	  $_SESSION['msg']="We cannot find an account with that mobile number";
 }
...
<body>
	...
	<form action="" method="post" id="form">
		...
		<ul>
        <h5 style="font-family:roboto;padding:2%;background-color:#3cb371;color:white;border-radius:3px;" id="login_msg">Login / Create a free  account  to post requirment.</h5>
        <br>
		<li><h2>Login</h2></li>
	   ...
	   <a href="user_post_signup.php" style="background-color:#cc324b;padding:3%;border:0;border-radius:3px;color:white;text-decoration:none;">Create a account</a>
       </div>
	   <br>
	   <br>
	</form>
